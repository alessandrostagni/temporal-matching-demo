...
curl --data-binary "@temporal-matching-server-1.0.0.tgz" http://localhost:8080/api/charts?force
curl --data-binary "@temporal-matching-frontend-1.0.0.tgz" http://localhost:8080/api/charts?force
curl --data-binary "@temporal-matching-1.0.0.tgz" http://localhost:8080/api/charts?force
helm repo update
